...
def main():
    ...
    for i in {0.01, 0.1, 1, 10}:
        l1 = i
        for j in {1, 10, 100, 1000}:#10
            l2 = j
            for k in {10, 100, 1000, 10000}:
                l3 = k
                for y in {0.8}: #0.001, 0.01, 0.1
                    l4 = y
                    for i1 in {0.3}: #0.00001, 0.0001, 0.001, 0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 2, 4, 6, 8, 10
                        l5 = i1
                        for j1 in {0.45}:
                            l6 = j1
                            for k1 in {0.01, 0.1, 1, 10}: # 0.01, 0.1
                                l7 = k1
                                for y1 in {150}:
                                    l8 = y1
